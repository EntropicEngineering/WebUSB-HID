...
declare module 'binary-parser'{
    ...
    namespace Parser {
        ...
        type Data = number | string | Buffer | Array<number | Parsed>;
        interface Parsed {
            [name: string]: Data;
        }
        ...
        interface Options {
            ...
            assert?: string | number | ((parsed: Data) => boolean);
        }

        interface StringOptions extends Options {
            encoding?: string;
            length?: number | string | ((parsed: Parsed) => number);
        ...
        interface ArrayOptions extends Options {
            type: string | Parser;
            length?: number | string | ((parsed: Parsed) => number);
            lengthInBytes?: number | string | ((parsed: Parsed) => number);
            readUntil?: string | ((item: number, buffer: Buffer) => boolean);
        }

        interface ChoiceOptions extends Options {
            tag: string | ((parsed: Parsed) => number);
