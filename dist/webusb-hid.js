...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_binary_parser__ = __webpack_require__(6);
...
let version_parser = new __WEBPACK_IMPORTED_MODULE_1_binary_parser___default.a()
    .endianness('little')
    .uint8('major')
    .bit4('minor')
    .bit4('patch');
function version(data_view) {
    return version_parser.parse(__WEBPACK_IMPORTED_MODULE_0_buffer___default.a.from(data_view.buffer));
}
...
function get_HID_descriptor(device, interface_id = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        let length = 9;
        let data = yield get_HID_class_descriptor(device, 33 /* HID */, 0, length, interface_id);
        let returned_length = data.getUint8(0);
        if (length < returned_length) {
            length = returned_length;
            data = yield get_HID_class_descriptor(device, 33 /* HID */, 0, length, interface_id);
        }
